...
export const clientsReducer = createReducer(
  ...
  // load
  on(clientsPageActions.loadClients, (state) => ({ ...state, errorOnLoadClients: false })),
  on(clientsPageActions.successOnLoadClients, (state, { clients }) => ({ ...state, clients })),
  on(clientsPageActions.errorOnLoadClients, (state) => ({ ...state, errorOnLoadClients: true })),
  // add
